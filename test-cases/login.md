...
|-------|-----------|--------------|-------|-----------------|---------------|--------|
| TC-01 | Login สำเร็จด้วยข้อมูลถูกต้อง | มีบัญชีอยู่แล้ว | 1. ไปที่หน้า Login 2. กรอก Phone Number: `0928849774` 3. กรอก OTP: `820386` 4. กด Login | Redirect ไปหน้า Account พร้อมข้อความต้อนรับ | เป็นไปตามที่คาด | ✅ Pass |
...
| TC-04 | Login ด้วย Phone Number ว่างเปล่า | - | 1. ปล่อย Phone Number ว่าง 2. กด Login | แสดง validation ไม่ให้ Submit | ไม่มี validation แสดง | ❌ Fail |
